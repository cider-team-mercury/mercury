...
\end{tabular}
\captionof{figure}{ Heat flux variations at the CMB in the case of a purely conductive mantle with negligible internal heating. }
\label{heat_flux}
\end{center}
...
\includegraphics[width=0.07\textwidth]{logo_cider.jpg}
