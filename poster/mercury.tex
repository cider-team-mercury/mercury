...
\end{tabular}
\captionof{figure}{Left: Thermal evolution of the mercurian mantle and core. This thermal evolution model couples the core thermodynamics in the previous section with the parameterized convection model of Stevenson et al (1983). The colored regions show the solution for models with $\pm \mathrm{100}$ degress C. Note the break in slope of the $\mathrm{T_cmb}$ temperature with the onset of inner core growth at $\sim 2.5\times10^2 \mathrm{Ma}$. Right: Growth of the Inner Core versus time. This model run yields an inner core of $ \sim 1400\mathrm{km}$, slightly exceeding the upper bound of inner core size as constrained by Dumberry and Rivoldini (2014).}
\label{flux}
\end{center}
...
M. Dumberry and A. Rivoldini, Mercury’s inner core size and core-crystallization regime, Icarus, 248, 254-268 (2014). \\
