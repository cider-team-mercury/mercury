...
\end{tabular}
\captionof{figure}{
Radial magnetic field at CMB for the 10 times larger heat flux heterogeneity case (right) and homogeneous heat flux case (left).
We model a thermally driven dynamo in a rotating spherical shell with $r_{i}/r_{o} = 0.35$ (i.e.  $r_i$ = 700km). 
 }
\label{dynamo}
\end{center}
